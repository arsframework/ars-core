...
public final class ResourcePrxHelper extends Ice.ObjectPrxHelperBase implements ResourcePrx
{
    ...
    private byte[] download(String id, int index, int length, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
    ...
    public Ice.AsyncResult begin_download(String id, int index, int length, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
    ...
    public Ice.AsyncResult begin_download(String id, int index, int length, java.util.Map<String, String> __ctx, Callback_Resource_download __cb)
    {
        return begin_download(id, index, length, __ctx, true, false, __cb);
    }

    public Ice.AsyncResult begin_download(String id, 
                                          int index, 
                                          int length, 
    ...
    private Ice.AsyncResult begin_download(String id, 
                                           int index, 
                                           int length, 
                                           java.util.Map<String, String> __ctx, 
    ...
    public Iresult invoke(String client, Itoken token, String uri, String parameter, java.util.Map<String, String> __ctx)
    {
        return invoke(client, token, uri, parameter, __ctx, true);
    }

    private Iresult invoke(String client, Itoken token, String uri, String parameter, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
    ...
    public Ice.AsyncResult begin_invoke(String client, Itoken token, String uri, String parameter, java.util.Map<String, String> __ctx)
    {
    ...
    public Ice.AsyncResult begin_invoke(String client, Itoken token, String uri, String parameter, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_invoke(client, token, uri, parameter, __ctx, true, false, __cb);
    }

    public Ice.AsyncResult begin_invoke(String client, Itoken token, String uri, String parameter, Callback_Resource_invoke __cb)
    {
        return begin_invoke(client, token, uri, parameter, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_invoke(String client, Itoken token, String uri, String parameter, java.util.Map<String, String> __ctx, Callback_Resource_invoke __cb)
    {
        return begin_invoke(client, token, uri, parameter, __ctx, true, false, __cb);
    }

    public Ice.AsyncResult begin_invoke(String client, 
                                        Itoken token, 
                                        String uri, 
                                        String parameter, 
    ...
    private Ice.AsyncResult begin_invoke(String client, 
                                         Itoken token, 
                                         String uri, 
                                         String parameter, 
                                         java.util.Map<String, String> __ctx, 
                                         ...
                                         IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_invoke(client, token, uri, parameter, __ctx, __explicitCtx, __synchronous, 
                            new IceInternal.Functional_TwowayCallbackArg1<ars.invoke.remote.slice.Iresult>(__responseCb, __exceptionCb, __sentCb)
                                {
                                    public final void __completed(Ice.AsyncResult __result)
                                    {
    ...
    private void upload(String name, byte[] buffer, int length, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
    ...
    public Ice.AsyncResult begin_upload(String name, byte[] buffer, int length, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
    ...
    public Ice.AsyncResult begin_upload(String name, byte[] buffer, int length, java.util.Map<String, String> __ctx, Callback_Resource_upload __cb)
    {
        return begin_upload(name, buffer, length, __ctx, true, false, __cb);
    }

    public Ice.AsyncResult begin_upload(String name, 
                                        byte[] buffer, 
                                        int length, 
    ...
    private Ice.AsyncResult begin_upload(String name, 
                                         byte[] buffer, 
                                         int length, 
                                         java.util.Map<String, String> __ctx, 
                                         boolean __explicitCtx, 
    ...
    {
        "::Ice::Object",
        "::ars::invoke::remote::slice::Resource"
    };
