...
public final class Beans {
    ...
    public static <T> T[] getArray(Class<T> type, int length) {
        ...
        if (length < 0) {
            throw new IllegalArgumentException("Length must not be less than 0, got " + length);
        }
     ...
     *
     * @param <M>         数据类型
     * @param collection1 对象集合
     * @param collection2 对象集合
     * @return 合并后的对象集合
     */
